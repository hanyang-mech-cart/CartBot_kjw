...
def generate_launch_description():
    ...
    # # docking 추가
    # my_docking_node = Node(
    #     package='my_docking',
    #     executable='docking',
    #     name='my_docking_node',
    # )
    
    # docking_cpp 추가
    my_docking_cpp_node = Node(
        package='my_docking_cpp',
        executable='docking',
        name='docking',
    )
    ...
    return LaunchDescription([
        ...
        my_docking_cpp_node, # 추가된 Docking_cpp 노드
        # my_docking_node  # 추가된 Docking 노드
    ])
